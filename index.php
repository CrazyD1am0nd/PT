          ...
          <form class="col-lg-12 mb-6" action="">
            <div class="form-row">
              ...
              <div class="col-12 col-md-3">
                <button type="submit" class="btn btn-block btn-primary">Load It!</button>
              </div>
            </div>
          </form>
        <div class="col-lg-12 ">
...
if (isset($_REQUEST['pic'])) {
    ...
    if (strpos($pic, 'http') === 0 && endswith($pic, '.gif')) {
        ...
        ?>
            <div class="col-lg-12 order-lg-2 text-danger">space and some special characters in the url are not allowed</div>
        <?php
        }
    }
